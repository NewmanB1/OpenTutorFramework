...
| **Authorization Spec** | `docs/AUTHORIZATION_AND_GOVERNANCE_SPEC_v1.md` | Verified | 2026-04 | Initial draft complete |
| **Knowledge Bundle Spec** | `docs/KNOWLEDGE_BUNDLE_SPEC_v1.1.md` | Verified | 2026-04 | Review for v1.2 pending |
